...
public class PneumaticCylinderPistonHeadRenderer extends SafeBlockEntityRenderer<PneumaticCylinderPistonHeadBlockEntity> {
    ...
    @Override
    protected void renderSafe(PneumaticCylinderPistonHeadBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource bufferSource, int light, int overlay) {
